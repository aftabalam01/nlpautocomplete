...
#DATA_PATH ='/Users/omkaragashe/Desktop/AutocompleteModel/nlpautocomplete/src/data/
class Vocabulary(object):
    ...
    def _build_vocab(self):
        ...
        print(f'new line idx is {voc2ind[self.STOP]}')
...
def tokenize_prepare_data():
    ...
    prepare_data(data_file=f'{DATA_PATH}/masterdata/master_train.txt', is_sample=True)
